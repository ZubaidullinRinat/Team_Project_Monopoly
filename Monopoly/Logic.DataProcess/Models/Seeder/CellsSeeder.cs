...
namespace Logic.DataProcess.Seeder
{
    public static class CellsSeeder
    {
        public static List<Cell> SeedCells()
        {
            ...
            cells.Add(new Railway("РИЖСКАЯ ЖЕЛЕЗНАЯ ДОРОГА", 5, 200,100));
            ...
            cells.Add(new Railway("КУРСКАЯ ЖЕЛЕЗНАЯ ДОРОГА",15,200,100));
            ...
            cells.Add(new Railway("КАЗАНСКАЯ ЖЕЛЕЗНАЯ ДОРОГА",25,200,100));
            ...
            cells.Add(new Railway("ЛЕНИНГРАДСКАЯ ЖЕЛЕЗНАЯ ДОРОГА",35,200,100));
