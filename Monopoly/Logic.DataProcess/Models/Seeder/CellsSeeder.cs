...
namespace Logic.DataProcess.Seeder
{
    public static class CellsSeeder
    {
        public static List<Cell> SeedCells()
        {
            ...
            cells.Add(new Property("ЖИТНАЯ УЛ.", 1, 2, 10, 30, 90, 160, 230, 50, 50, 30));
            cells.Add(new CardPick("ОБЩЕСТВЕННАЯ КАЗНА", 2, Models.Cells.Type.CommunityChest));
            cells.Add(new Property("НАГАТИНСКАЯ УЛ.", 3, 4, 20, 60, 180, 320, 450, 50, 50, 30));
            cells.Add(new Tax("ПОДОХОДНЫЙ НАЛОГ", 4, 200));
            cells.Add(new Railway("РИЖСКАЯ ЖЕЛЕЗНАЯ ДОРОГА", 5));
            cells.Add(new Property("ВАРШАВСКОЕ ШОССЕ", 6, 6, 30, 90, 270, 400, 550, 50, 50, 50));
            cells.Add(new CardPick("ШАНС", 7, Models.Cells.Type.Chance));
            cells.Add(new Property("УЛ. ОГАРЕВА", 8, 6, 30, 90, 270, 400, 550, 50, 50, 50));
            cells.Add(new Property("ПЕРВАЯ ПАРКОВАЯ УЛ.", 9, 8, 40, 100, 300, 450, 600, 50, 50, 60));
